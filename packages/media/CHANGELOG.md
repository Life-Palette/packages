...
- [`5591058`](https://github.com/Life-Palette/packages/commit/559105866fcc70a0b98213272a4acbf7d82c6b61) Thanks [@IceyWu](https://github.com/IceyWu)! - 修复媒体元数据测试在不同 Node 环境下的 `metaprobe` 解析，并提升上传器在严格 TypeScript 配置下的兼容性。
